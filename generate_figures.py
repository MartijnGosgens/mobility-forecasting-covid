...
def compute_historical_concentrations(date_until=None):
    ...
    if date_until is None:
        date_until = datetime(2020,11,1)
    while date < date_until:
        try:
            mmdd = rivm.date2mmdd(date)
...
def historical_concentrations(load_results=False,date_until=None):
